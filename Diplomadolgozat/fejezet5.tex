...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item A hangfájlt elküldjük az API-n keresztül az AI szolgáltatáshoz
        ...
        \item A generált választ text to speech AI által hanggá alakítjuk, ezt eltároljuk egy mappába
...
Az adatbázis MSSQL segítségével íródott. \cite{mssql} Ennek kiválasztásakor a teljesítmény, skálázhatóság és könnyen integrálhatóság volt a szempont. A .NET keretrendszerrel és a Visual Studioval nagyon jól integrálható ez, így mindenképp a legjobb választásnak bizonyult.
